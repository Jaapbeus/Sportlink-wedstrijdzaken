...
param functionAppName string = 'func-[clubcode]-sportlink'
...
param storageAccountName string = '[storage-account]'

@description('Naam van de Static Web App')
param staticWebAppName string = 'swa-[clubcode]-sportlink'

@description('Naam van de Application Insights resource')
param appInsightsName string = 'ai-[clubcode]-sportlink'
