...
/// <c>FunctionApp.Tests/Email/EmailClassificationServiceTests.cs</c> (#972 — port van
/// EmailProcessorFunction). Woordelijke kopie.
/// </summary>
...
/// <summary>
/// Regressietests voor de promptopbouw van <see cref="BerichtAiService"/> — woordelijke kopie van
/// <c>FunctionApp.Tests/Email/EmailClassificationServiceTests.cs</c>'s <c>BerichtAiServicePromptTests</c>.
/// Deze methoden bestonden al vóór #972 (vrijwel woordelijke kopie van het SQL Server-origineel) —
/// alleen nooit getest op deze tier.
/// </summary>
public class BerichtAiServicePromptTests
{
    ...
    public void BouwClassificatieUserPrompt_InjectiePoging_StaatBinnenHetDatablok()
    {
        ...
        prompt.Should().Contain(injectie);
    ...
    public void BouwKnvbStalenessWaarschuwing_VerlopenRegels_NoemtSchemaveldKnvbNotitie()
    {
        ...
        waarschuwing.Should().NotContain("knvbWaarschuwing");
    }
...
/// <summary>
/// Regressietests voor <see cref="BerichtAiService.ParseClassificatieResponse"/> — woordelijke
/// kopie van <c>FunctionApp.Tests/Email/EmailClassificationServiceTests.cs</c>'s
/// <c>BerichtAiServiceParseTests</c>.
/// </summary>
