...
/// <summary>
/// Postgres-tier-tegenhanger van <c>FunctionApp.Tests/Email/TestDoubles/FakeEmailGraphService.cs</c>
/// (#972 — port van EmailProcessorFunction). Woordelijke kopie.
/// </summary>
internal sealed class FakeEmailGraphService : IEmailGraphService
{
    ...
    /// verzendintentie al in de database staat vóórdat de mail de deur uit gaat — de volgorde is daar
    /// het hele punt, en die is niet te zien aan de eindtoestand.
    /// </summary>
