...
|---|---|
| `CLAUDE.md` | Buildproces, git-workflow, statuslabels of een Claude-instructie gewijzigd (géén architectuurregel — zie §13.1 van ARCHITECTUUR.md) |
...
> het bijbehorende `ARCHITECTUUR-<ONDERWERP>.md`; een instructie voor hoe Claude zelf werkt hoort
