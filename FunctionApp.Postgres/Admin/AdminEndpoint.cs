...
/// <c>SportlinkEndpointSupport.ExecuteWedstrijdzakenAsync</c>, dat op <see cref="ExecuteAsync"/>
/// uitkomt. Een losse <c>EasyAuthHelper.RequireAdmin</c>-aanroep in een endpoint wordt door
/// <c>scripts/ci/check-endpoint-autorisatie.sh</c> geweigerd, en
/// <c>FunctionApp.Postgres.Tests/EndpointAutorisatieTests.cs</c> bewijst per endpoint dat de poort
...
internal static class AdminEndpoint
{
    ...
    // als de SQL Server-tier. De parameter is verwijderd en niet alleen ongebruikt gelaten: een
