...
/// <summary>
/// Postgres-tier-tegenhanger van <c>FunctionApp/Email/EmailBatchFilterService.cs</c> (#972 — port
/// van EmailProcessorFunction). Woordelijke kopie: pure filterlogica zonder databaseafhankelijkheid.
/// </summary>
