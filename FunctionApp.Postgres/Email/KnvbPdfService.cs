...
/// <summary>
/// Postgres-tier-tegenhanger van <c>FunctionApp/Email/KnvbPdfService.cs</c> (#561/#1141). Leest de
/// KNVB-speeldagenkalender-PDF's die als Content-bestanden meereizen in het Function App-
/// deploymentpakket (zie <c>FunctionApp.Postgres.csproj</c>'s <c>Content Include</c>, die naar
/// dezelfde bronbestanden verwijst als de SQL Server-tier) — geen nieuwe Azure-resource, kosten
/// blijven €0.
///
/// <para>
...
/// </para>
/// </summary>
internal static class KnvbPdfService
{
    ...
    /// </summary>
    internal static async Task<EmailBijlage?> GetKalenderPdfAsync(string regio, string seizoen, ILogger log)
    {
