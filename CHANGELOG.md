...
### Added
- **Fundament gelegd voor betrouwbaardere teamherkenning in inkomende e-mail** (#692, #696, #697). Teamnamen komen in veel schrijfwijzen binnen — "JO13-2", "JO 13-2", "jo13/2", "13-1" zonder duidelijk JO/MO-prefix — en werden tot nu toe op meerdere losse plekken met eigen regex geraden, met kans op fouten (bijv. een tegenstander die abusievelijk als eigen team werd herkend). Deze wijziging voegt een nieuwe, centrale teamnaam-normalisatie en -vertaling naar een canoniek TeamId toe (`dbo.Teams`, `dbo.TeamAliassen`), volledig los van de bestaande e-mailverwerking getest — de bestaande verwerking verandert hierdoor nog niet van gedrag. Vervolgstappen (aansluiten op de nachtelijke synchronisatie en op de e-mailpipeline zelf) volgen als aparte, kleinere wijzigingen.
