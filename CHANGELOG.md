...
- **Security-scan scope uitgebreid naar alle docs/** (#240): `pii-docs` job scant nu alle `docs/*.md` bestanden met `git ls-files`. Gerelateerd: `coach@vrc.nl` in `docs/API.md` vervangen door `trainer@voorbeeld.nl`.
