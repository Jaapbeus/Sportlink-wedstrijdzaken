...
#if DEBUG
        public static async Task Run([TimerTrigger("0 0/1 * * * *", RunOnStartup = true)] TimerInfo myTimer, FunctionContext context)
#else
        public static async Task Run([TimerTrigger("0 0/1 * * * *")] TimerInfo myTimer, FunctionContext context)
#endif
        {
