...
- **PRDSqlConnectionString**: Azure SQL (production)
  ```
  Server=sqlsrv-dev-vrc-01.database.windows.net;Database=db-dev-vrc-01;...
  ```
...
| `scheidsrechters` | string | Full referee description | `H. (Henry) van de Vosse (Scheidsrechter)` |
| `scheidsrechter` | string | Referee name | `H. (Henry) van de Vosse` |
